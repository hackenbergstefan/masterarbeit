...
\setheadsepline{0pt}
\chead{\sffamily\headmark}
\ohead{\tikz[remember picture]{\node[outer sep=5pt,inner sep=0pt,font=\sffamily]
  (a) {\sffamily\pagemark};}%
  \tikz[remember picture, overlay]{
    \ifthenelse{\isodd{\thepage}}{
      \draw ($(a.north west)+(-5pt,0)$) |- ($(a.south east)+(0,-5pt)$);
      \draw ($(a.south west)+(-5pt,0)$)  -- (a.south west -| current page text area.north
      west);
    }{
      \draw ($(a.north east)+(5pt,0)$) |- ($(a.south west)+(3pt,-5pt)$);
